...
describe('reviseUrlQuery', () => {
  ...
  it('测试 reviseUrlQuery 函数功能-search', () => {
    expect(reviseUrlQuery({ search: { param1: undefined } }, 'https://example.com?param1=value1')).toBe('https://example.com/');
    expect(reviseUrlQuery({ search: { param1: undefined } }, 'https://example.com?param1=value1&param2=value2')).toBe('https://example.com/?param2=value2');
  });
  it('测试 reviseUrlQuery 函数功能-hash', () => {
    expect(reviseUrlQuery({ hash: { param1: undefined } }, 'https://example.com/#index/?param1=value1')).toBe('https://example.com/#index/');
    expect(reviseUrlQuery({ hash: { param1: undefined } }, 'https://example.com/#index/?param1=value1&param2=value2')).toBe('https://example.com/#index/?param2=value2');
  });
});
