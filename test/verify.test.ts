...
import { isArray, isArrObj, isBasicType, isBoolean, isDate, isDom, isEmptyObject, isEqual, isFunction, isIncludeChinese } from '@/index'
import { isInt, isJsonString, isLocation, isMap, isNullOrUndefined, isNumber, isObject, isPhone, isPromise, isSet, isString, isSymbol } from '@/index';
